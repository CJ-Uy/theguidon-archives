...
export default function MobileMenu({ show, onClose }: Props) {
  const nav: NavRow[] = [
    ...
    { link: "/releases/recent", text: "Recently Uploaded" },
    { link: "/releases/press", text: "Press Issues" },
    { link: "/releases/gradmag", text: "Graduation Magazines" },
    { link: "/releases/freshmanual", text: "Freshmanuals" },
    { link: "/releases/uaap-primer", text: "UAAP Primers" },
    { link: "/releases/legacy", text: "Over the Years" },
    { link: "/releases/others", text: "Others" },
    {
      link: "/about",
      text: "About",
      icon: (
  ...
  return (
    <>
      <div
        className={`bg-tint ${show ? "active" : ""}`}
        onClick={onClose}
      />
      <div id="mobile-menu" className={show ? "active" : ""}>
        <div className="head">
